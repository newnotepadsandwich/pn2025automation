// Sample script data - Replace with your actual scripts
const scriptsData = [
    {
        id: 1,
        ...
        game: "Cookie Clicker",
        version: "v2.1.0",
        description: "Advanced auto-clicking script with customizable intervals, target detection, and anti-detection features.",
        features: [
    ...
    },
    {
        ...
        game: "Strategy Games",
        version: "v1.5.2",
        description: "Automatically manage your resources, optimize production, and plan upgrades across multiple strategy games.",
        features: [
    ...
    },
    {
        ...
        game: "Web Games",
        version: "v3.0.1",
        description: "Transform game interfaces with modern UI elements, dark modes, and customizable themes.",
        features: [
            "Modern UI redesign",
            "Dark/Light themes",
    ...
    },
    {
        ...
        game: "Trading Games",
        version: "v1.8.0",
        description: "Track market trends, analyze prices, and get notifications for the best trading opportunities.",
        features: [
    ...
    },
    {
        ...
        game: "RPG Games",
        version: "v2.3.1",
        description: "Advanced combat helper with skill rotations, buff tracking, and damage optimization.",
        features: [
    ...
    },
    {
        ...
        game: "MMORPG",
        version: "v1.2.4",
        description: "Optimize your questing routes, track objectives, and maximize experience gains.",
        features: [
            "Route optimization",
            "Quest tracking",
            "XP calculations",
...
function initializeDonationButtons() {
    ...
    if (paypalBtn) {
        paypalBtn.href = 'https://paypal.me/yourusername'; // Replace with your PayPal.me link
        paypalBtn.onclick = () => trackDonation('PayPal');
    }
    
    if (kofiBtn) {
        kofiBtn.href = 'https://ko-fi.com/yourusername'; // Replace with your Ko-fi link
        kofiBtn.onclick = () => trackDonation('Ko-fi');
    }
    
    if (patreonBtn) {
        patreonBtn.href = 'https://patreon.com/yourusername'; // Replace with your Patreon link
        patreonBtn.onclick = () => trackDonation('Patreon');
    }
}
