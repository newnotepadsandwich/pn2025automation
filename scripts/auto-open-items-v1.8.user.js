// ==UserScript==
// @name         Auto Open Items 1.8 Speed Slider
                ...
                if (img && img.src.includes(targetSrc)) {
                    ...
                    setTimeout(() => {
                        ...
                        if (useBtn) {
                            ...
                            setTimeout(() => {
                                const acceptBtn = document.querySelector('#game-container > div:nth-child(6) > div.themed_panel.theme__transparent--original > div > div:nth-child(2) > button:nth-child(2)');
                                if (acceptBtn && acceptBtn.textContent.trim() === "Accept") {
                                    console.log("Accept button found - clicking");
                                    acceptBtn.click();
                                }
                                // Mark processing as complete regardless
                                isProcessing = false;
                            }, clickDelay);
                        } else {
                        ...
                        if (useBtn) {
                            ...
                            if (withAccept) {
                                setTimeout(() => {
                                    const acceptBtn = document.querySelector('#game-container > div:nth-child(6) > div.themed_panel.theme__transparent--original > div > div:nth-child(2) > button:nth-child(2)');
                                    if (acceptBtn && acceptBtn.textContent.trim() === "Accept") {
                                        console.log(`Accept button for ${label} clicked`);
                                        acceptBtn.click();
                                    }
                                    isProcessing = false;
                                }, clickDelay);
